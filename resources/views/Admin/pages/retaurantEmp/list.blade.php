...
<a  href="/restaurant/emp/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>{{trans('dashboard.TableAdd')}}  مسئول   </a></h3>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title">ادارة المشرفين</h2>
                                
                                <div class="table-responsive m-t-40">
@if($admins->isEmpty())
  <h1> لا يوجد مشرفين     </h1>
 @else 
