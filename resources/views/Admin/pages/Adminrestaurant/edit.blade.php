...
<img src="{{asset($restaurant->main_image)}}" width=150px>
          ...
          <form   
      role="form" action="{{route('restaurant.Edit.Submit')}}" method="post" enctype="multipart/form-data" >
          @csrf
             ...
             <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    @foreach($restaurant->type as $reType)

                    @if($type->id == $reType->id)
...
@if($category->catergory =='reservation')
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <input type="number"  class="form-control" id="InputNameEn" value="{{$category->reservation_count}}" name="reservation_count">
                  </div>

                    <div class="form-group col-md-6">
                    <label for="InputNameEn">  (دقيقة) وقت الغاء الحجز في حاله عدم الغاء الحجز   </label>
                    <input type="number"  class="form-control" id="InputNameEn" value="{{$category->reservation_time}}" name="reservation_time" >
                  </div>


                    <div class="form-group col-md-6">
                    <label for="InputNameEn">    قيمةالدفعة المسبقة للحجز   </label>
                    <input type="number"  class="form-control" id="InputNameEn" value="{{$category->reservation_price}}"  name="reservation_price">
                  </div>
 </div>                  
@else
...
@if($category->catergory =='delivery')
                  ...
                  <div id="showdelivery" >
                    ...
                    <input type="number"  class="form-control" id="InputNameEn"  name="delivery_price" value="{{$category->delivery}}">
                  </div>
</div>
@else
                  ...
                  <div id="showdelivery" hidden="true">
...
@if($category->catergory =='crub')
                  <div class="checkbox col-md-6">
                  <input type="checkbox"   name="is_crub"  value="crub" checked="true">
...
$('#addList').click(function(){
  $('#addList').before( "<input type='text' class='form-control'   name='services[]' style='margin-top:10px'>");
});
