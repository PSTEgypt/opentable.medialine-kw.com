          ...
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="InputNameEn1">{{trans('dashboard.InputNameEn')}} </label>
                    <input type="text" class="form-control" id="InputNameEn1"  name="name_en">
                  </div>
                  
                  <div class="form-group">
                    <label for="InputNameEn2">{{trans('dashboard.description_en')}} </label>
                    <textarea type="text" class="form-control" id="InputNameEn2"  name="description_en"> </textarea>
                  </div>
                <!-- /.card-body -->
