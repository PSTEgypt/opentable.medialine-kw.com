...
<a  href="/admin/type/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>{{trans('dashboard.TableAdd')}}  نوع مطعم   </a></h3>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title">انواع المطاعم  </h2>
...
@foreach($types as $type)
                                            ...
                                            <tr>
                                                <td>
                          <a href="/admin/type/info/{{$type->id}}">{{$type->name}}</a>
                                                </td>
                                                <td>
                                                  {{$type->description}}
                                                </td>
                                                <td>
        <a href="/admin/type/edit/{{$type->id}}" class="btn btn-primary">{{trans('dashboard.TableEdit')}} </a>
                                                </td>

                                                 <td>
        <a href="/admin/type/info/{{$type->id}}" class="btn btn-dark">{{trans('dashboard.show')}} </a>
                                                </td>
