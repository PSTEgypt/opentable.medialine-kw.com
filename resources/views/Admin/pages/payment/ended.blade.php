...
<a href="/admin/payment/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>اضافة  اشتراك    </a>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title">ادارة الاشتركات</h2>
...
@foreach($restaurant_payment as $payment)
        ...
        @else
        <th><span class="badge bg-warning">لم يتم الدفع  </span> </th>
        @endif  

<th>{{Carbon\Carbon::parse($payment->created_at)->format('Y-m-d H:m a')}}</th>
<th>
@if($payment->is_pay == 0)
<a href="/admin/payment/pay/{{$payment->id}}" class="btn btn-dark"> دفع  </a>
@endif
<a href="/admin/payment/delete/{{$payment->id}}" class="btn btn-warning">{{trans('dashboard.TableDelete')}} </a></th>
