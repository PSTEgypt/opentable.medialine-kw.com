...
<a  href="/admin/type/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>{{trans('dashboard.TableAdd')}}  
              المستخدميين        
   </a></h3>
                    </div>
...
<th> {{$user->phone}}</th>
@if($user->is_active == 1)
<th><a  href="/admin/user/status/{{$user->id}}" class="btn btn-success">{{trans('dashboard.Active')}}</a></th>
@else
