...
@foreach($categories as $category)
        <tr>
<th> <a href="/admin/category/info/{{$category->id}}">{{$category->name}}</a></th>
<th>{{$category->description}}</th>

<th><a href="/admin/category/edit/{{$category->id}}" class="btn btn-block btn-info btn-flat">{{trans('dashboard.TableEdit')}} </a></th>
...
<a  href="/admin/category/add" class="btn btn-block btn-success btn-lg"> <i class="fa fa-plus" aria-hidden="true"></i>{{trans('dashboard.TableAdd')}}  قسم  </a>
</div>
@endslot
@endcomponent
 @endsection     
