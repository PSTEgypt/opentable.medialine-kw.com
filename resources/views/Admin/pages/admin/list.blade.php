...
<a  href="/admin/admin/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>  {{trans('dashboard.sectionAdmin')}}   </a></h3>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title">المسئولين  </h2>
...
@endif
<th><a href="/admin/admin/edit/{{$admin->id}}" class="btn btn-dark"> {{trans('dashboard.TableUpdate')}} </a></th>
<th><a href="/admin/admin/delete/{{$admin->id}}" class="btn btn-warning"> {{trans('dashboard.TableDelete')}} </a></th>
