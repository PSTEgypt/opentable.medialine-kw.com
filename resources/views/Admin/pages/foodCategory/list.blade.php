...
<a  href="/restaurant/foodCategory/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>{{trans('dashboard.TableAdd')}}  صنف     </a></h3>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title">  ادارة الاصناف   </h2>
