...
@component('components.error',['errors'=>$errors ?? NULL]) @endcomponent
                            ...
                            <div class="card-body">
                                <h2 class="card-title">  تعديل الاصناف </h2>
  
      <form role="form" action="{{route('foodCategory.edit.submit',$type->id)}}" method="post" enctype="multipart/form-data">
          @csrf
                <div class="card-body">
                  <div class="form-group col-md-6">
                    <label for="InputNameAr">{{trans('dashboard.ProductName')}} </label>
                    <input type="text" class="form-control" id="InputNameAr" value=" {{$type->name}}" name="name">
                  </div>

                  <div class="form-group col-md-6">
                 <label for="name_en">{{trans('dashboard.ProductName_ar')}} </label>
                    <input type="text" class="form-control" id="name_en" value=" {{$type->name_en}}" name="name_en">
                  </div>
