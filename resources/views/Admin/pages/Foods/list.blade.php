...
<a  href="/restaurant/food/add" class="btn btn-success  "> <i class="fa fa-plus" aria-hidden="true"></i>{{trans('dashboard.TableAdd')}}  وجبة  </a></h3>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title"> ادارة الوجبات</h2>
...
<th><a href="/restaurant/food/delete/{{$ad->id}}" class="btn btn-block btn-danger btn-flat">{{trans('dashboard.TableDelete')}} </a></th>
        </tr>
