  ...
  <form role="form" action="{{route('food.add.submfood ')}}" method="post" enctype="multipart/form-data">
             ...
             <input type="text" class="form-control" id="name_en"  name="name_en">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <textarea id="some-textarea1" class="form-control"   name="description" placeholder="وصف الوجبة " ></textarea>

                  </div>


                   <div class="form-group col-md-6">
                    <label for="description_en">  وصف الوجبة بالانجلزية </label>
                    <textarea id="some-textarea1" class="form-control"   name="description_en" placeholder="ووصف الوجبة بالانجلزية" ></textarea>
