...
@component('components.error',['errors'=>$errors ?? NULL]) @endcomponent
                            ...
                            <div class="card-body">
                                <h2 class="card-title">  تعديل وجبة</h2>
...
<img src="{{asset($ad->image)}}" width=150px height="150px">
          ...
          <div class="card-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                    <label for="name_en">      اسم الوجبة   بالأنجلزية  </label>
             <input type="text" class="form-control" id="name_en"  name="name_en" value="{{$ad->name_en}}">
                  </div>
              ...
              <textarea id="some-textarea1" class="form-control"   name="description" placeholder=" وصف المطعم" >{{$ad->description}}</textarea>
                    ...
                    <div class="form-group col-md-6">
                    <label for="some-textarea2">   وصف الوجبة بالانجلزية  </label>
                    <textarea id="some-textarea2" class="form-control"   name="description_en" placeholder=" وصف المطعم" >{{$ad->description_en}}</textarea>
