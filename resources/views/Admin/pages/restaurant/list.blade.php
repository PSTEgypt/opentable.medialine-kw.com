                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title"> المطاعم </h2>
...
<th><a href="/admin/restaurant/edit/{{$restaurant->id}}" class="btn btn-dark">{{trans('dashboard.TableEdit')}} </a></th>
<th><a href="/admin/restaurant/delete/{{$restaurant->id}}" class="btn btn-warning">{{trans('dashboard.TableDelete')}} </a></th>
