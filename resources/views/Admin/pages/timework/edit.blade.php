 ...
 تعديل مواعيد العمل
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">ad basic</li>
                        </ol>
                    </div>
                    <div>
...
@component('components.error',['errors'=>$errors ?? NULL]) @endcomponent
    ...
    <form role="form" action="{{route('timework.submitEdit',$ad->id)}}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="InputNameAr"  value="{{$ad->day}}" name="day">
                  </div>

                    <div class="form-group col-md-6">
                    <label for="InputNameAr">  موعد بداء وانتهاء العمل      </label>
                    <input type="time" class="form-control" id="InputNameAr" value="{{$ad->work_from}}" placeholder="من" name="work_from">
</br>
                    <input type="time" class="form-control" id="InputNameAr"  value="{{$ad->work_to}}"  placeholder="الي "   name="work_to">
