...
@extends('layoutDashboard.app',['title'=>'انواع المطعم '] )
@section('content')

@component('components.panel',['subTitle'=>'  بيانات نوع المطعم  '])
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <span>{{$type->description}}</span> <b class="float-right">  الوصف  </b>
                  </li>
