...
<a href="/restaurant/order/accept/{{$order->id}}" class="btn btn-block btn-success btn-flat">تاكيد الطلب </a>
<a href="/restaurant/order/info/{{$order->id}}" class="btn btn-block btn-primary btn-flat">عرض</a>
<a href="/restaurant/order/cancel/{{$order->id}}" class="btn btn-block btn-danger btn-flat"> الغاء الطلب  </a>
...
<th>
<a href="/restaurant/order/delivered/{{$order->id}}" class="btn btn-block btn-info btn-flat">تم التوصيل </a>
