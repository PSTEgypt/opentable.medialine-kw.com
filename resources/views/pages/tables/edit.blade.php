...
@component('components.panel',['subTitle'=>'تعديل طاولة '])
<div class="container-fluid">
        <div class="row">
          <div class="col-md-12 ">
          <form role="form" action="{{route('table.submitEdit',$ad->id)}}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
          ...
          <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="InputNameAr"  name="table_id" value="{{$ad->table_id}}">
                  </div>

                    <div class="form-group col-md-6">
                    <label for="InputNameAr">  عدد الاشخاص  للطاولة      </label>
                    <input type="number" class="form-control" id="InputNameAr" placeholder="من" name="count_from" value="{{$ad->count_from}}">
</br>
                    <input type="number" class="form-control" id="InputNameAr"  placeholder="الي "   name="count_to" value="{{$ad->count_to}}">
